  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        child: CustomizedAppbar(title: "Manage Admin", backButton: true),
      ),
                          ...
                          return Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                CircleAvatar(
                                  radius: 24,
                                  backgroundColor: isAdmin ? const Color(0xFF1A1A1A) : const Color(0xFFF8F6F3),
                                  child: Text(
                                ...
                                Obx(() => controller.isUpdating.value
                                  ...
                                  : GestureDetector(
                                      onTap: () => showDialog(
                                        context: context,
                                        builder: (context) => DialogManageAdmins(
